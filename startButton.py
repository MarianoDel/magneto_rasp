...
def GetSTBImage(state):
    if state == 0:
        image = wx.Image("/home/pi/Desktop/Magneto_simple_v1/StartButtonImagenes/StartButton_Unpressed.png", wx.BITMAP_TYPE_ANY)
    else:
        image = wx.Image("/home/pi/Desktop/Magneto_simple_v1/StartButtonImagenes/StartButton_Pressed.png", wx.BITMAP_TYPE_ANY)
    return image



class StBtnFrame(wx.Panel): #(wx.PyPanel): #PyPanel also works
  ...
  #def __init__(self, parent, id=wx.ID_ANY, pos=(50,50), size=(50,450), style=0, name="MyPanel"):
    ...
    super(StBtnFrame, self).__init__(parent, id, pos, size, style, name)
...
#    print(dc)
    ...
    dc.DrawBitmap(bitmap, 17, 20, True)
